...
#' `Scale`-arguments in [fxext_layer_scale()] and e. g. slight theme tweaks
#' might make sense sometimes.
#'
#' @export

setGeneric("fxext_layer_other",
           function(fx_geom, aes_name, ...)
             standardGeneric("fxext_layer_other"))

#' @rdname fxext_layer_other
#'
#' @export

setMethod("fxext_layer_other",
