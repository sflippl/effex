...
For now, an introduction to `effex` can be found in my [Bachelor's Thesis](https://github.com/sflippl/bachelor-thesis/blob/master/_book/bachelor-thesis.pdf).

The package [`vdem.effex`](https://github.com/sflippl/vdem.effex) applies `effex` to the [V-Dem database](v-dem.net).
